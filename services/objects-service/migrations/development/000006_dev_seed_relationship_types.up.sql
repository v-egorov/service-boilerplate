...
DECLARE
    rel_type_id BIGINT;
BEGIN
    -- Get or create the RelationshipType marker
    ...
    RETURNING id INTO rel_type_id;

    -- Create base objects for each relationship type
    ...
    -- Now create the relationship type entries
