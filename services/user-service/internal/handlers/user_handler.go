...
func (h *UserHandler) CreateUser(c *gin.Context) {
	...
	// Get authenticated user ID (actor performing the creation)
	...
	if err != nil {
		...
		h.auditLogger.LogUserCreation(actorUserID, requestID, "", ipAddress, userAgent, traceID, spanID, false, err.Error())
		return
	}
	...
	h.auditLogger.LogUserCreation(actorUserID, requestID, user.ID.String(), ipAddress, userAgent, traceID, spanID, true, "")
